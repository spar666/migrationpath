...
interface MigrationProspectusProps {
  fullName: string;
  personaType: string;
  pointsScore: number;
...
export const MigrationProspectus = ({
  fullName,
  personaType,
  pointsScore,
  pointsBreakdown,
    ...
    <Document>
      ...
      <Page size="A4" style={styles.coverPage}>
        ...
        <View style={styles.coverMain}>
          <Text style={styles.coverTitle}>Personalized Migration Strategy</Text>
      ...
      {/* Strategic Summary & Next Steps Page */}
      <Page size="A4" style={[styles.page, styles.contentPage]}>
        <View style={styles.pageHeader}>
          <Text style={styles.pageHeaderLogo}>MigrationPath</Text>
        ...
        <Text style={[styles.sectionSubtitle, { marginTop: 24 }]}>Action Plan</Text>
